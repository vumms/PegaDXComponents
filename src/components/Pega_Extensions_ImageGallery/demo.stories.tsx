...
import PegaExtensionsImageGallery from './index';
import { pyReviewRaw, pyReviewResolved, regionChildrenResolved } from './mock';
import StatusWorkRenderer from './StatusWork';

const meta: Meta<typeof PegaExtensionsImageGallery> = {
  title: 'PegaExtensionsImageGallery',
  component: PegaExtensionsImageGallery,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaExtensionsImageGallery>;
...
export const BasePegaExtensionsImageGallery: Story = args => {
  const props = {
  ...
  return (
    <PegaExtensionsImageGallery {...props} {...args}>
      {regionAChildren}
      {regionBChildren}
    </PegaExtensionsImageGallery>
  );
};

BasePegaExtensionsImageGallery.args = {};
