...
export declare const getPreSelectedTableDataListIds: (disbursementTableData: any) => any;
export declare const getPreSelectedTableDataList: (disbursementTableData: any) => any;
